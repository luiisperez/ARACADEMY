...
<div class="row" style="margin:5%">
  ...
  <div class="col-md-6 mb-4">
    ...
    <div class="card gradient-card">
        ...
        <div class="third-content ml-auto mr-4 mb-2" style="margin: 5% !important">
          <div class="row">
            <h4 class="font-weight-bold float-left">Asignación de módulos a profesores</h4>
          </div>
          <div class="row">
            <p class="text-muted">Módulo para la asignación de módulosn de cursos a profesores en el sistema.</p>
          </div>
        </div>
  ...
  <div class="col-md-6 mb-4">
    ...
    <div class="card gradient-card">
        ...
        <div class="third-content  ml-auto mr-4 mb-2" style="margin: 5% !important">
          <div class="row">
            <h4 class="font-weight-bold float-left">Listado de módulos por Profesores</h4>
          </div>
          <div class="row">
            <p class="text-muted">Modulo para la visualización de los profesores con sus módulos asociados en el sistema</p>
          </div>
        </div>
