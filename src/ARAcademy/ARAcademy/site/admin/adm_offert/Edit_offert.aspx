<%@ Page Title="" Language="C#" MasterPageFile="~/site/admin/Admin_home.Master" AutoEventWireup="true" CodeBehind="Edit_offert.aspx.cs" Inherits="ARAcademy.site.admin.adm_offert.Edit_offert" %>
            ...
            <div class="card" style="margin:5%">
                <div class="card-body" >
                        ...
                        <div class="form-group" style="margin-top:7%">
                            <asp:button runat="server" type="button" Text="Actualizar Oferta" class="btn btn-success btn-lg btn-block login-button" style="border-radius:20px; width:30%; margin:auto; border:0px"  required="required" OnClick="Upd_off"/> 
                        </div>
                    </div>
            </div>
