<%@ Page Title="" Language="C#" MasterPageFile="~/site/admin/Admin_home.Master" AutoEventWireup="true" CodeBehind="list_mod.aspx.cs" Inherits="ARAcademy.site.admin.list_mod" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function alertmeErr() {
            Swal.fire({
                title: 'Ha ocurrido un error al eliminar el módulo.',
                width: 500,
                padding: '3em',
                imageUrl: "/site/home/images/Check_Mark.png",
                imageAlt: 'Custom image',
                        ...
                        <asp:Repeater ID="mod_data" runat="server" OnItemCommand="mod_ItemCommand">
                            <ItemTemplate>
                                    <tr id="<%# Eval("Id") %>">
                                        ...
                                        <td> <asp:Label ID="email" runat="server" text='<%# Eval("Course.Name") %>'></asp:Label></td>
                                        <td><%# Eval("name") %></td>
