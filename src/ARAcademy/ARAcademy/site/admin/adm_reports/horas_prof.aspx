...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <h3 style="font-weight:bold; text-align:center; margin-bottom:5%">Horas por profesor</h3>
                                ...
                                <div class="row" style="margin-top: 10px">                                
                                    ...
                                    <label>Seleccione profesor</label>
                                        ...
                                        <div class="col-7">
	                                <asp:DropDownList ID="list_prof" runat="server" style="background-color: #eee; padding: 10px 10px;margin: 8px 0; width:100%; border:none; height:80%; " required="required" AutoPostBack="True"  >
                                    </asp:DropDownList>
                                            </div>
                                             </div>
                                    ...
                                    <div class="col-6" style="text-align:center;align-self:end;">
                                        <asp:button runat="server" type="button" Text="Generar reporte" class="btn btn-success btn-lg btn-block login-button" style="border-radius:20px; width:auto; margin:auto; border:0px" OnClick="prof_search" required="required" /> 
                                    </div>

                                    <%--<div class="col-md-5">
                                        <asp:button runat="server" type="button" Text="expoprtar" class="btn btn-success btn-lg btn-block login-button" style="border-radius:20px; width:70%; margin:auto; border:0px" OnClick="ExportToExcel" required="required" /> 
                                    </div>--%>
                        ...
                        <asp:Repeater ID="prof_pagos" runat="server">
                            <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><%# Eval("Teacher.lastname") %></td>
                                        <td><%# Eval("Agenda") %> </td>
                                        <td><%# Eval("Section.Name")%></td>
                                        <td><%# Eval("Duration") + " Minutos" %></td>                                       
                                    </tr>              
                            </ItemTemplate>
                        </asp:Repeater>
                </tbody>
  ...
  <%--              <div class="row" style="text-align:center; margin-bottom:20px">
                    <asp:button ID="export" runat="server" type="button" Text="Generar CSV" class="btn btn-success btn-lg btn-block login-button" style="border-radius:20px; text-align: center; width:auto; margin:auto" OnClick="ExportToExcel"/> 
                </div>--%>
    </div>
</asp:Content>
