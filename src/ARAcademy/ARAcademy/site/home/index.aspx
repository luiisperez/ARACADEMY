<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ARAcademy.site.home.index" %>
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-4">
            <h1 class=""><a href="index.html"><img src="images/logo.png" width="70" height="70" alt="ARAcademy"></a></h1>
          </div>
